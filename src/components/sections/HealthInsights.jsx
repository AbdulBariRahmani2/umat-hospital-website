...
export default function HealthInsights() {
  ...
  return (
    <section id="health" className="relative py-24 lg:py-32 bg-secondary/40">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-14">
          ...
          <Reveal delay={0.12}>
            <a href="#news" className="group inline-flex items-center gap-2 text-sm font-semibold text-foreground hover:text-primary transition-colors">
              All articles
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          ...
          <Reveal className="lg:col-span-7">
            <a href="#health" className="group relative flex h-full flex-col justify-end overflow-hidden rounded-3xl border border-border/70 bg-card p-8 min-h-[420px]">
          ...
          <div className="lg:col-span-5 space-y-5">
            {rest.map((a, i) => (
              <Reveal key={a.title} delay={0.1 + i * 0.08}>
                <a href="#health" className="group flex gap-5 rounded-2xl border border-border/70 bg-card p-5 transition-all hover:border-primary/40 hover:shadow-md">
