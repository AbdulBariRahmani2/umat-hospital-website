            ...
            <div className="relative grid lg:grid-cols-12 gap-10 items-center">
              <div className="lg:col-span-7">
                ...
                <h2 className="mt-3 font-heading text-3xl lg:text-5xl font-semibold tracking-tight text-balance">
                  Ready when you need specialized care
                </h2>
                <p className="mt-4 max-w-xl text-background/70 text-pretty">
                  Book a consultation, find a specialist, or come to emergency — we are here on Darulaman Road, next to the National Museum.
                </p>
